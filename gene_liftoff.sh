...
cd ${bl}
cat GCA_041002825.1_ASM4100282v1_genomic.fna | sed -E s/'>.*contig_([0-9]+),.*'/'>contig_\1'/g >AP_genome.fasta
...
liftoff -p 8 -g ${anno}/AP_renamed.gff -o AP_lifted_PC.gff -u AP_unmapped_features.txt ${bl}/C01_final.fasta.masked ${bl}/AP_genome.fasta
conda deactivate
